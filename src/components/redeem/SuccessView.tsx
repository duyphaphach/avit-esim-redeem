  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-8">
      <div className="text-center space-y-4 mb-8">
        ...
        <p className="text-sm bg-muted inline-block px-4 py-2 rounded-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-center">
        {qrCodes.map((qr) => (
          <div key={qr.id} className="bg-card border rounded-2xl p-6 flex flex-col items-center justify-between text-center shadow-sm">
            ...
            <Button variant="outline" className="w-full gap-2" onClick={() => handleDownload(qr.qrcode, qr.iccid)}>
